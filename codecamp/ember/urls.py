from codecamp.ember.views import SessionList, SessionDetail, SpeakerList, SpeakerDetail, RatingList, RatingDetail, TagList, TagDetail, RatingBySessionList
from django.views.decorators.csrf import csrf_exempt
from django.conf.urls.defaults import patterns, url, include

urlpatterns = patterns('',
    url(r'^/ratings/$', csrf_exempt(RatingList.as_view())),
    ...
    url(r'^/sessions/(?P<session_pk>\d+)/ratings/$', csrf_exempt(RatingBySessionList.as_view())),
